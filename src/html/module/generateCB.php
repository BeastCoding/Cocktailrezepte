...
function crKategorie($check){
  ...
  foreach ($conn->query($sql) as $row) {
      if(in_array($row['ID'],$check)){
          echo "<input form='form_rezepte' type='checkbox' name='kategorie[]' value= " . $row['ID'] . " checked>"   . $row['Cocktailart'] ."<br>";
      }else{
          echo "<input form='form_rezepte' type='checkbox' name='kategorie[]' value= " . $row['ID'] . ">"   . $row['Cocktailart'] ."<br>";
      }
...
function crAlkohol($check){
    if(in_array('alkoholfrei',$check)){
        echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'alkoholfrei' checked> alkoholfrei <br>";
    }else{
        echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'alkoholfrei'> alkoholfrei <br>";
    }
    if(in_array('mäßig',$check)){
         echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'mäßig' checked> mäßig <br>";
    }else{
         echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'mäßig'> mäßig <br>";
    }
    if(in_array('normal',$check)){
         echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'normal' checked> normal <br>";
    }else{
         echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'normal'> normal <br>";
    }
    if(in_array('stark',$check)){
         echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'stark' checked> stark <br>";
    }else{
         echo "<input form='form_rezepte' type='checkbox' name='cocktail[]' value= 'stark'> stark <br>";
    }
